    ...
    def __init__(self, submission_types, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                ...
                HTML(
                    '<div class="form-group col-md-6 mb-0">{% if entry.video_file %}<video height="auto" width="auto" type="video/mp4" controls><source src="{{entry.video_file.url}}" >Your browser does not support HTML5 video.</video>{% endif %}</div>'),
